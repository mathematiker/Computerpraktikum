...
//Erstellt die  M*LxM*L Matrix für mode 0, d.h. auf dem Quadrat [0,1]x[0,1]
//M=Anzahl Blöcke
//L=Größe der Blöcke
...
//Erstelle L erstellt die NxN Matrix für den L-Shape
...
//multipliziert die Matrix aus Erstelle/ErstelleL mit einem Vektor und gibt das Ergebinis zurück ,
//wobei nur die Nichtnull-Einträge berücksichtigt werden
...
//CG löst das Gleichungssystem Ax=b für gegebenen Vektor b und der Matrix A aus Erstelle/ErstelleL nach x auf
...
//PoissonDiff gibt die diskretisierte Lösung unseres Problems für Schrittweite 1/(n-1) zurück
//-für Mode 0 auf dem Quadrat
//-für Mode 1 auf dem L-Bereich
...
//Fehler gibt den Fehler zwischen der diskretisierten Lösung mit Schrittweite 1/(n-1) und der wahren Lösung zurück
